...
<html>
    ...
    <body>
	  ...
	  <a href='delete.php?shoppingcartitemid=$Sno'>Delete</a>
	</span></button></td>
	<td> 
	<a href='update.php?shoppingcartitemid=$Sno'>Update</a>
						</td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        ...
        <strong>Total: &euro; <?=number_format($this->cart->getTotal()/100, 2)?></strong></br>
	</table>
